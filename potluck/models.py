...
class PotluckItem(models.Model):
	potluckItem_text = models.CharField(max_length=200, default="I.E. Canopy or 2x Dog Collar(s)")
...
class PotluckItemForm(forms.ModelForm):
	class Meta:
		...
		labels = {
			...
			'potluckItem_text' : 'Potluck Item(s) or Raffle Item(s) you are Bringing'
		}
